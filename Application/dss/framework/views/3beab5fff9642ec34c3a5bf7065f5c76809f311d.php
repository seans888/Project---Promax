              ...
              <div class ="row">
                <div class = "col-sm-3">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type = 'text' class="form-control" name = 'referencenumber' value = '<?php echo e($Model->ReferenceNumber()); ?>' id='getPayment_id' <?php echo e(($Model->status != null && $Model->status != App\Constants::DRAFT) ? "disabled" : ""); ?>/>
                    </div>
                  </div>
                </div>
                <div class = "col-sm-3">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type = 'text' readonly class="form-control" name = 'status' id='getPayment_status' value ="<?php echo e(($Model->status != null) ? $Model->status : App\Constants::DRAFT); ?>" <?php echo e(($Model->status != null && $Model->status != App\Constants::DRAFT) ? "disabled" : ""); ?> />
                ...
                <div class = "col-sm-3">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input required type = 'date' class="form-control" name = 'date' value = '<?php echo e($Model->date); ?>' id='getPayment_date' <?php echo e(($Model->status != null && $Model->status != App\Constants::DRAFT) ? "disabled" : ""); ?>/>
                    </div>
                  </div>
                </div>
                <div class = "col-sm-3">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input required type = 'number' step = '0.01' class="form-control" name = 'amount' value = '<?php echo e($Model->amount); ?>' id='getPayment_date' <?php echo e((($Model->status != null && $Model->status != App\Constants::DRAFT) || $Model->amount > 0) ? "disabled" : ""); ?>/>
                    </div>
                  </div>
                </div>
              </div> <!-- end row -->
              <div class = "row">
                <div class = "col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-11">
                      <input type = 'text' class = "form-control" value = "<?php echo e($Model->desc); ?>" name = "desc"  <?php echo e(( ($Model->status != null && $Model->status != App\Constants::DRAFT)) ? "disabled" : ""); ?> <?php echo e(($Model->status == null) ? "required" : ""); ?> />
                    </div>
                  </div>
                </div>
              </div><!-- end row -->
              ...
              <div class ="row">
                ...
                <div class = "col-sm-3">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type = 'number' step="0.01" class = "form-control" name = "paymentAmountForInvoice"  <?php echo e(( ($Model->status != null && $Model->status != App\Constants::DRAFT)) ? "disabled" : ""); ?> <?php echo e(($Model->status == null) ? "required" : ""); ?> <?php echo e(($Model->amount > 0) ? "max=" . $Model->PaymentAvailableBalance() . "":""); ?> min = "1"/>
                    </div>
                  </div>
                </div>
